...
void VkApp::setupLights()
{
	...
	//point light
	mLightUBO.lights[0].isEnabled	= true;
	mLightUBO.lights[0].lightType	= LightType::Point;
	mLightUBO.lights[0].ambient		= glm::vec4(0.01, 0.01, 0.01, 1.0);
	mLightUBO.lights[0].diffuse		= glm::vec4(16.0f, 16.0f, 16.0f, 1.0f);		//white light
	mLightUBO.lights[0].specular	= glm::vec4(16.0f, 16.0f, 16.0f, 1.0f);		
	...
	mLightUBO.lights[0].ambient     = glm::vec4(0.01, 0.01, 0.01, 1.0);
	mLightUBO.lights[0].diffuse     = glm::vec4(16.0f, 0.0f, 0.0f, 1.0f);		//red light
	mLightUBO.lights[0].specular    = glm::vec4(16.0f, 16.0f, 16.0f, 1.0f);		
	mLightUBO.lights[0].cutOff		= glm::cos(glm::radians(45.0f));
	mLightUBO.lights[0].outerCutOff = glm::cos(glm::radians(50.0f));*/
