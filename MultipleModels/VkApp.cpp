...
void VkApp::initialize()
{
	...
	//mTestTeapot = mRenderSystem.createModel(TEA_MODEL_PATH, TEA_TEXTURE_PATH);

	mTestPlane->mScale = glm::vec3(2.0f, 2.0f, 2.0f);
	//mTestTeapot->mPosition = glm::vec3(5.0f, 2.0f, 5.0f);
	//mTestTeapot->mScale = glm::vec3(0.01f, 0.01f, 0.01f);
}
